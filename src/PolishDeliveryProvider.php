 ...
 */
class PolishDeliveryProvider implements DeliveryProviderInterface
{
    /**
    ...
    public function getHolidays(int $year): array
    {
        ...
        $this->addHoliday(
            $easterDateTime->add(new DateInterval('P48D'))->format('Y-m-d')
        ); //Zesłanie Ducha Świętego (Zielone Świątki), 50 dni po niedzieli wielkanocnej
        $this->addHoliday(
            $easterDateTime->add(new DateInterval('P11D'))->format('Y-m-d')
